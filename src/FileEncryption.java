...
//             FileOutputStream outputStream = new FileOutputStream(getEncryptedFileName(inputFile))) {
...
//        }
//
//        return new File(getEncryptedFileName(inputFile));
//    }
//
...
//             FileOutputStream outputStream = new FileOutputStream(getDecryptedFileName(encryptedFile))) {
//            Cipher cipher = Cipher.getInstance(ALGORITHM);
...
//        }
//
//        return new File(getDecryptedFileName(encryptedFile));
//    }
//
